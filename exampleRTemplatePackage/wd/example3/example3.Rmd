---
title: "Example 3: PimaIndiansDiabetes data (boxplot, histogram, pairwise comparison and linear discriminant analysis)"
...
```{r runDocument, echo = FALSE, eval = FALSE}
	...
	system.time(rmarkdown::render("example3.Rmd"))
...
```{r inputParameters-data}
	...
	variables <- grep("diabetes", colnames(dataset), 
...
```{r inputParameters-analysis}
    ...
    pairwiseComparisonPlotColorVariable <- "diabetes" 
	typePlot <- "ggplot2"
