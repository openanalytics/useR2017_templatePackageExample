...
```{r inputParameters-analysis}
	...
	# 'pairwiseComparisonPlot': boolean, should each pair of 'variables'
	# be represented in paired scatterplot 
	# (with the function 'pairwiseComparisonPlot' of the package)
	...
	## input parameters for a linear discrimant analysis of the data
